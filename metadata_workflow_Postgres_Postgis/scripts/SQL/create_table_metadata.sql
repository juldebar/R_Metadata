...
COMMENT ON COLUMN metadata.related_ sql_query IS 'the SQL query to be executed to get this dataset';
COMMENT ON COLUMN metadata.elated_view_name IS 'the name of the view to directly access this dataset (if it exists)';
